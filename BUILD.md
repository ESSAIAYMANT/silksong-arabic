...
No GitHub Actions signing workflow is active yet. Local PowerShell tests are the currently implemented build/test mechanism, not a claim of verified hosted builds or byte-for-byte reproducibility of RC3.
